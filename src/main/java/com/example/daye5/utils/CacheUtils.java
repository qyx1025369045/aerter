...
public class CacheUtils {
    ...
    public static String getTotalCacheSize() {
        long cacheSize = getFolderSize(MyApp.getContext().getCacheDir());
        if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
            cacheSize += getFolderSize(MyApp.getContext().getExternalCacheDir());
        }
    ...
    public static String getCacheDir() {
        ...
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
            ...
            cachePath = MyApp.getContext().getExternalCacheDir().getPath();
        } else {
            cachePath = MyApp.getContext().getCacheDir().getPath();
        }
        return cachePath;
    }
    ...
    public static void clearAllCache() {
        ...
        if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
            deleteDir(MyApp.getContext().getExternalCacheDir());
        }
    }
